import {MenuItem} from "../../../shared/models/ui/menu";
export class MenuService {
  menu: MenuItem[] = [
    ...
    {path: '/surveys', title: 'Опросы', icon: 'check_circle', background: 'http://www.mrmediatraining.com/wp-content/uploads/2014/05/Man-on-the-Street-Interview.jpg'},
